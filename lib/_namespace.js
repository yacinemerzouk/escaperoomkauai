...
EscapeRoom.Collections.Coupons = new Mongo.Collection('coupons');
EscapeRoom.Collections.Games = new Mongo.Collection('games');
 ...
 * RESERVATIONS COLLECTION RULES
 */
EscapeRoom.Collections.Coupons.allow({
    insert: function( userId, doc ){
        return userId ? true : false;
    },
    update: function( userId, doc ){
 ...
 */
EscapeRoom.Collections.Games.allow({
    insert: function( userId, doc ){
        return userId ? true : false;
    },
    update: function( userId, doc ){
...
EscapeRoom.getPossibleTimes = function( date ){
    var possibleTimes = [];
    ...
    var rooms = EscapeRoom.Collections.Rooms.find({available:true}).fetch();
...
if( Meteor.isClient ) {
    ...
    EscapeRoom.showProcessing = function(){
        $('.processing-bg').show();
    }
    EscapeRoom.hideProcessing = function(){
        $('.processing-bg').hide();
    }
    ...
    EscapeRoom.getConfirmationEmailBody = function( resId ){
        ...
        var reservation = EscapeRoom.Collections.Reservations.findOne(resId);

        var room = EscapeRoom.Collections.Rooms.findOne(reservation.roomId);
    ...
    /**
     * FUNCTION EscapeRoom.getNotificationEmailBody
     *
     ...
     * @returns String : the email body HTML
     */
    EscapeRoom.getNotificationEmailBody = function( resId ){
        var reservation = EscapeRoom.Collections.Reservations.findOne(resId);
    ...
    /**
     * FUNCTION EscapeRoom.getFollowUpEmailBody
     *
     ...
     * @returns String : the email body HTML
     */
    EscapeRoom.getFollowUpEmailBody = function(  ){
