...
Bolt.getAdminStartTimes = function(){
    ...
    possibleTimes.push( x + '12:00pm' );
    possibleTimes.push( x + '12:05pm' );
    possibleTimes.push( x + '12:10pm' );
    possibleTimes.push( x + '12:15pm' );
    possibleTimes.push( x + '12:20pm' );
    possibleTimes.push( x + '12:25pm' );
    possibleTimes.push( x + '12:30pm' );
    possibleTimes.push( x + '12:35pm' );
    possibleTimes.push( x + '12:40pm' );
    possibleTimes.push( x + '12:45pm' );
    possibleTimes.push( x + '12:50pm' );
    possibleTimes.push( x + '12:55pm' );
    for( var x = 1; x <= 10; x++ ){
    ...
    Meteor.methods({
        ...
        adminCreateReservation: function( formData ){
            ...
            if( gameCount === 0 ) {
                ...
                // Create reservation
                var reservationData = formData;
                var resInsert = Bolt.Collections.Reservations.insert( reservationData );
                ...
                var gameInsert = Bolt.Collections.Games.insert( gameData );
